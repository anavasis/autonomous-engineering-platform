...
$testFiles = [
    ...
    __DIR__ . '/Application/MissionEngine/ExecuteImplementationStepContextTest.php',
    __DIR__ . '/Application/MissionEngine/ExecuteImplementationEvidenceTest.php',
    __DIR__ . '/Application/MissionEngine/ApproveInspectionStepIdempotencyTest.php',
    __DIR__ . '/Application/MissionEngine/MissionEngineContextPersistenceTest.php',
    __DIR__ . '/Application/MissionEngine/CommitPrCompletionHonestyTest.php',
    __DIR__ . '/Application/MissionEngine/RealProviderVerifiedPatchE2ETest.php',
    ...
    __DIR__ . '/Infrastructure/Execution/ProviderRoutingFailClosedTest.php',
    __DIR__ . '/Infrastructure/Validation/DeclarativeContextValidationEvidenceTest.php',
    ...
    __DIR__ . '/Application/MissionControl/ApprovalQueryInspectionDedupeTest.php',
    ...
    __DIR__ . '/Application/MissionExecution/LaunchFacadeProviderSelectionTest.php',
    ...
    __DIR__ . '/Application/EngineeringExecution/DiffCollectorRepositoryTest.php',
    __DIR__ . '/Application/EngineeringExecution/ResultNormalizerEvidenceTest.php',
    ...
    __DIR__ . '/Application/EngineeringWorkspace/EngineeringWorkspaceGitIdentityTest.php',
